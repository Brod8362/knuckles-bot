...
object Translations extends Enumeration {
  ...
  val MEME_COMMAND_ARGUMENT_NAME = "meme.options.the_meme.name"
  val MEME_COMMAND_ARGUMENT_DESC = "meme.options.the_meme.description"
  ...
  val UNHOME_COMMAND_ARGUMENT_NAME = "unhome.options.server_id.name"
  val UNHOME_COMMAND_ARGUMENT_DESC = "unhome.options.server_id.description"
